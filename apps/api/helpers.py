...
def extract_date_range(question, user_local_datetime, timezone_offset_minutes):
    ...
    prompt = (
        ...
        "2. These phrases do NOT indicate a date range and must always return null: "
        "'last time', 'most recent', 'latest', 'first time', 'ever', "
        "and their equivalents in any language. They describe a relative occurrence, not a time period.\n"
        "3. If you can identify a time period — even if phrased informally or ambiguously — "
        ...
        "4. These words always indicate a time reference and must always produce a date range, "
        ...
        "5. Be generous in interpreting all other time references. "
        "Informal or indirect phrasing still has a clear meaning — "
        "calculate the range that best matches the intent.\n"
        "6. Only apply these time-of-day defaults when NO specific hour is given: "
        ...
        "7. The question may be in any language. Understand the meaning before calculating.\n"
        "8. Return ONLY the JSON object or the word null. No explanation, no markdown, no extra text.\n\n"
